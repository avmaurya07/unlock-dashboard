...
const menu = [
  { label: "Dashboard", icon: "bi-grid", to: "/admin/dashboard" },
  ...
  { label: "Publisher Types", icon: "bi-tags", to: "/admin/publisher-types" },
  { label: "Event Categories", icon: "bi-collection", to: "/admin/event-categories" },
  { label: "Job Categories", icon: "bi-briefcase", to: "/admin/job-categories" },
  { label: "Funding Categories", icon: "bi-lightbulb", to: "/admin/funding-categories" },
  { label: "Organizer Types", icon: "bi-people-fill", to: "/admin/organizer-types" },
  { label: "Startup Stages", icon: "bi-rocket", to: "/admin/startup-stages" },
