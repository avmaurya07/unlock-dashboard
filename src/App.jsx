...
import ChallengeCategories from "./pages/admin/ChallengeCategories";
import OrganizerTypes from "./pages/admin/OrganizerTypes";
import StartupStages from "./pages/admin/StartupStages";
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/admin" element={<AdminLayout />}>
          ...
          <Route path="funding-categories" element={<ChallengeCategories />} />
          <Route path="organizer-types" element={<OrganizerTypes />} />
          <Route path="startup-stages" element={<StartupStages />} />
