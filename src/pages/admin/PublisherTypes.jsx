...
export default function PublisherTypes() {
  ...
  const saveType = async () => {
    ...
    try {
      ...
      if (mode === "create") {
        ...
        await api(`/api/admin/publisher-types/${currentId}`, {
          method: "PATCH",
          body: JSON.stringify({ name: n, description: d }),
        });
        toast.success("Publisher type updated");
      }
  ...
  const toggleActive = async (t) => {
    try {
      ...
      await api(`/api/admin/publisher-types/${t._id}`, {
        method: "PATCH",
        body: JSON.stringify({ isActive: !t.isActive }),
      });
      toast.success(t.isActive ? "Type deactivated" : "Type activated");
